    ...
    <div className="containerStock">
      ...
      {filterDoneCode.map((code, index) => (
        <div key={code._id} className="boxStockCard">
          ...
          <Dialog open={typeA}>
            <DialogContent>
              <DialogContentText>{`Modificar pileta${index + 1
                }:`}</DialogContentText>
              <h4>Tipo de acero:</h4>
              <Container
                width="100%"
          ...
          <Dialog open={instalationType}>
            <DialogContent>
              <DialogContentText>{`Modificar Instalación${index + 1
                }:`}</DialogContentText>
          ...
          <Dialog open={openAcc}>
            <DialogContent>
              <DialogContentText>{`ACCESORIOS Pileta${indexStock + 1} - ${itemModif + 1
                }:`}</DialogContentText>
              <div className="itemsEditAcc">
