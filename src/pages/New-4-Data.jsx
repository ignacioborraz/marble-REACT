...

                    {
                        cantData.map((cant, index) =>
                            <div key={index} >
                                ...
                                <label className='ml10'><input type="checkbox" id="cbox1" value={true} />Cod.Interno</label>
                                <label className='ml10'><input type="checkbox" id="cbox2" value={true} />Nota del Pedido </label>
